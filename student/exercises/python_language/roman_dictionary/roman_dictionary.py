...
# 1. Print out the names for all of Antony's friends.
print "Mark's friends: " + ', '.join(friends.keys())

# 2. Now all of their addresses.
print "Mark's friends' addresses: " + ', '.join(friends.values())
...
# 5. Make a list of everyone
everyone = dict(friends)
...
# 6. Get Cleo's address
print "Cleopatra's address is " + everyone['cleopatra']
