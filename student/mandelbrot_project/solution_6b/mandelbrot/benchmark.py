...
from mandelbrot.model.core_numba import mandelbrot_grid as mg_numba
...
start_time = time.time()
escape_times = mg_numba(x_bounds, y_bounds, n_points)
print 'Numba code (sec):', time.time() - start_time
